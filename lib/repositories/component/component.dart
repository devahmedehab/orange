...
Widget myDivider({required double width}) => Padding(
...
Widget myDefaultButton(
        {double? height, double? width, String? text, Function()? onPressed}) =>
    Container(
      height: height,
      width: width,
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(35), color: Colors.brown[800]),
